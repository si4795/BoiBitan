...
class BookCatalog {
  ...
  static final List<Book> books = [
    ...
    const Book(
      ...
      downloadUrl: 'https://archive.org/download/in.ernet.dli.2015.302106/2015.302106.Devdas.pdf',
      previewUrl: 'https://archive.org/details/in.ernet.dli.2015.302106',
      assetPdfPath: 'assets/sample_book.pdf',
      isFeatured: true,
      isTrending: true,
    ),
    ...
    const Book(
      ...
      category: 'Science & Sci-Fi',
      categoryBn: 'বিজ্ঞান ও ফিকশন',
      description: 'A gripping sci-fi adventure exploring artificial intelligence, clones, and deep space exploration by acclaimed author Muhammed Zafar Iqbal.',
      descriptionBn: 'মুহাম্মদ জাফর ইকবালের জনপ্রিয় সায়েন্স ফিকশন উপন্যাস। কৃত্রিম বুদ্ধিমত্তা, ক্লোনিং ও মানব অস্তিত্বের গভীর দার্শনিক প্রশ্নের রোমাঞ্চকর আখ্যান।',
      coverUrl: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=600&q=80',
      rating: 4.88,
      reviewCount: 3420,
      pageCount: 144,
      ...
      downloadUrl: 'https://ia800605.us.archive.org/23/items/SahajPath-Part1-Bangla/bangla-sahaj-paath1.pdf',
      previewUrl: 'https://archive.org/details/SahajPath-Part1-Bangla',
      assetPdfPath: 'assets/sample_book.pdf',
      isFeatured: true,
      isTrending: true,
    ),
